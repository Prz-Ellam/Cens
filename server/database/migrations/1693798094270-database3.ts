...
export class Database31693798094270 implements MigrationInterface {
    name = 'Database31693798094270';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`followers\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`followers\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
            `ALTER TABLE \`followers\` ADD CONSTRAINT \`FK_5147cc94953ebd1ac56fd71303e\` FOREIGN KEY (\`follower_user_id\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
